...
export interface IStorage {
  ...
  updateLogoRequestWithResults(
    id: string,
    logos: GeneratedLogo[]
  ): Promise<LogoRequest | undefined>;
}
...
export class MemStorage implements IStorage {
  ...
  async createLogoRequest(
    insertRequest: InsertLogoRequest
  ): Promise<LogoRequest> {
    const id = randomUUID();
  ...
  async updateLogoRequestWithResults(
    id: string,
    logos: GeneratedLogo[]
  ): Promise<LogoRequest | undefined> {
