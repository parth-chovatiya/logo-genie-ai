...
import { logoGenerationRequestSchema, type LogoGenerationRequest, type GeneratedLogo } from "@shared/schema";
...
export default function HeroForm({ onGenerate, onLoading, onError }: HeroFormProps) {
  ...
  const onSubmit = async (data: LogoGenerationRequest) => {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : "Failed to generate logos. Please try again.";
    ...
    <div className="max-w-2xl mx-auto text-center mb-16">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground max-w-xl mx-auto">
          Generate stunning, unique logo designs for your brand in seconds. Powered by advanced AI technology.
        </p>
      </div>

      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="bg-card border border-border rounded-xl p-8 shadow-lg space-y-6">
          <FormField
